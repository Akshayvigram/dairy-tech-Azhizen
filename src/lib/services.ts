...
export const services: Service[] = [
  ...
  // ==================== CATEGORY 2: GOAT FARM SERVICE ====================
  {
    ...
    keyFeatures: [
      "Breed selection consulting for your climate and goals",
      "Genetic quality assessment of livestock",
      "Sourcing from trusted, certified breeders",
      "Farm construction and infrastructure setup"
    ]
  },
  {
    id: 6,
    ...
    keyFeatures: [
      "Routine health monitoring and assessments",
      "Preventive care planning and vaccination schedules",
      "Emergency veterinary response and treatment",
      "Disease management and herd health optimization"
    ]
  },
  {
    id: 7,
    ...
    keyFeatures: [
      "Automated goat milking system installation",
      "Precision feeding system setup",
  ...
  },
  {
    ...
    keyFeatures: [
      "Scalable infrastructure design for herd growth",
      "Modular automation system expansion",
      "Additional livestock procurement support",
      "Performance optimization for larger operations"
    ]
  },

  // ==================== CATEGORY 3: Poultry Farm Service ====================
  {
    id: 9,
    ...
    keyFeatures: [
      "Automated feed dispensing systems",
      "Nutrient composition optimization",
      "Waste reduction and feed efficiency tracking",
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      "Alert notifications for climate deviations"
    ]
  },
  {
    id: 11,
    ...
    keyFeatures: [
      ...
      "Airborne pathogen detection sensors",
      "Predictive disease outbreak alerts",
      "Biosecurity compliance automation"
    ]
  },
  {
    id: 12,
