...
//         "http://localhost:5000/api/enquiries/submit-contact",
//         {
//           method: "POST",
...
//   return (
//     <div className="bg-white w-full min-h-screen flex flex-col relative overflow-x-hidden">
//       <Navbar />
...
//                       className="transition-all w-10 h-10 flex items-center justify-center text-black hover:text-[#8dc201]"
//                       title={social.label}
//                     >
//                       {social.icon}
//                     </a>
...
//                   <button
//                     type="submit"
//                     className="bg-[#8dc201] text-black px-10 py-3 rounded-lg font-semibold text-[15px] hover:bg-[#7ab001] transition-colors cursor-pointer"
//                   >
//                     Send a message
//                   </button>
//                 </div>
...
export const ContactPage = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://dairy-tech-azhizen.onrender.com/api/enquiries/submit-contact",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(formData),
